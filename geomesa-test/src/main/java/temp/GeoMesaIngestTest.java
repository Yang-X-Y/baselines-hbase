...
public class GeoMesaIngestTest {
    ...
    public static void main(String[] args) {
        ...
        String geomType = args[3];
        String precision = args[4];
        GeoMesaIngestTest ingestGeom = new GeoMesaIngestTest();
        ...
        try {
            ...
            // 创建schema
            SimpleFeatureType sft = SimpleFeatureTypes.createType(typeName, String.format("*geom:%s:srid=4326", geomType));
