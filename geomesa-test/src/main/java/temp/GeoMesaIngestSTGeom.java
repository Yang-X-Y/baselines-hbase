...
public class GeoMesaIngestSTGeom {
    /**
    ...
    public SimpleFeatureType getSimpleFeatureType(String typeName,String geom) {
        ...
        //设置xz3索引时间间隔为天
//        sft.getUserData().put("geomesa.xz3.interval", precision);
        //设置时空索引时间字段为date
    ...
    public static void main(String[] args) {
        ...
        GeoMesaIngestSTGeom demo01 = new GeoMesaIngestSTGeom();
        ...
        try {
            ...
            // 创建schema
            SimpleFeatureType sft = demo01.getSimpleFeatureType(typeName,geom);
        ...
        for(String inputFile : inputFiles){
            try {
                ...
                while ((line = bufferedReader.readLine())!= null){
                    ...
                    if (lng < -180 || lng > 180 || lat < -90 || lat > 90 || strings[1].length()<4 || strings[2].length()<4) continue;
